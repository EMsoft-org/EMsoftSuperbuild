...
elseif(WIN32)
  FILE(APPEND ${EMsoftOO_SDK_FILE} "set(NLopt_DIR \"\${EMsoftOO_SDK_ROOT}/${extProjectName}-${NLopt_VERSION}-\${BUILD_TYPE}/lib/cmake/${extProjectName}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoftOO_SDK_FILE} "if(NOT EXISTS \"\${NLopt_DIR}\" AND EXISTS \"\${EMsoftOO_SDK_ROOT}/${extProjectName}-${NLopt_VERSION}/lib/cmake/${extProjectName}\")\n")
  FILE(APPEND ${EMsoftOO_SDK_FILE} "  set(NLopt_DIR \"\${EMsoftOO_SDK_ROOT}/${extProjectName}-${NLopt_VERSION}/lib/cmake/${extProjectName}\" CACHE PATH \"\" FORCE)\n")
