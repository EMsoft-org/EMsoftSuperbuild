...
elseif(MSVC_IDE)
  ...
  FILE(APPEND ${EMsoftOO_SDK_FILE} "set(BSPLINEFORTRAN_DIR \"\${BSPLINEFORTRAN_INSTALL}/lib\" CACHE PATH \"\")\n")
elseif(WIN32)
  FILE(APPEND ${EMsoftOO_SDK_FILE} "set(BSPLINEFORTRAN_INSTALL \"\${EMsoftOO_SDK_ROOT}/${extProjectName}-${BSPLINEFORTRAN_VERSION}-\${BUILD_TYPE}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoftOO_SDK_FILE} "set(BSPLINEFORTRAN_DIR \"\${BSPLINEFORTRAN_INSTALL}/lib\" CACHE PATH \"\")\n")
else()
...
FILE(APPEND ${EMsoftOO_SDK_FILE} "set(BSPLINEFORTRAN_CMAKE_DIR \"\${BSPLINEFORTRAN_INSTALL}/lib/cmake/${extProjectName}-${FC_NAME}-${BSPLINEFORTRAN_VERSION}\" CACHE PATH \"\")\n")
FILE(APPEND ${EMsoftOO_SDK_FILE} "if(EXISTS \"\${BSPLINEFORTRAN_CMAKE_DIR}\")\n")
FILE(APPEND ${EMsoftOO_SDK_FILE} "  set(BSPLINEFORTRAN_DIR \"\${BSPLINEFORTRAN_CMAKE_DIR}\" CACHE PATH \"\" FORCE)\n")
...
if(FC_NAME STREQUAL "intelllvm")
  FILE(APPEND ${EMsoftOO_SDK_FILE} "set(${extProjectName}-intel_DIR \"\${BSPLINEFORTRAN_DIR}\" CACHE PATH \"\")\n")
endif()
