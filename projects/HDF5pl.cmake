...
set(HDF5PL_INSTALL "${EMsoft_SDK}/${extProjectName}-${HDF5_VERSION}-${CMAKE_BUILD_TYPE}")
set(HDF5_ROOT "${HDF5_INSTALL}")
set(PLUGIN_SOURCE "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/Source/${extProjectName}")
set(TGZstring "TGZ")
...
ExternalProject_Add(${extProjectName}
  ...
  TMP_DIR "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/tmp/${CMAKE_BUILD_TYPE}"
  STAMP_DIR "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/Stamp/${CMAKE_BUILD_TYPE}"
  DOWNLOAD_DIR "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}"
  SOURCE_DIR "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/Source/${extProjectName}"
  BINARY_DIR "${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/Build/${CMAKE_BUILD_TYPE}"
  INSTALL_DIR "${HDF5PL_INSTALL}"

  CMAKE_ARGS
    -C ${EMsoft_SDK}/superbuild/${extProjectName}-${HDF5PL_VERSION}/Source/${extProjectName}/config/cmake/cacheinit.cmake
...
FILE(APPEND ${EMsoft_SDK_FILE} "#--------------------------------------------------------------------------------------------------\n")
FILE(APPEND ${EMsoft_SDK_FILE} "# HDF5_plugins Library Location\n")
if(APPLE)
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_INSTALL \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5PL_VERSION}-\${BUILD_TYPE}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_DIR \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5PL_VERSION}-\${BUILD_TYPE}/cmake\" CACHE PATH \"\")\n")
elseif(WIN32)
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_INSTALL \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5_VERSION}-\${BUILD_TYPE}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_DIR \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5_VERSION}-\${BUILD_TYPE}/cmake/hdf5\" CACHE PATH \"\")\n")
else()
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_INSTALL \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5_VERSION}-\${BUILD_TYPE}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_DIR \"\${EMsoft_SDK_ROOT}/${extProjectName}-${HDF5_VERSION}-\${BUILD_TYPE}/cmake\" CACHE PATH \"\")\n")
endif()
FILE(APPEND ${EMsoft_SDK_FILE} "set(CMAKE_MODULE_PATH \${CMAKE_MODULE_PATH} \${HDF5PL_DIR})\n")
FILE(APPEND ${EMsoft_SDK_FILE} "set(HDF5PL_VERSION \"${HDF5PL_VERSION}\" CACHE STRING \"\")\n")
