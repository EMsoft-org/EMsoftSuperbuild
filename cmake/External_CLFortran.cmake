...
if(APPLE)
  FILE(APPEND ${EMsoft_SDK_FILE} "set(CLFORTRAN_INSTALL \"\${EMsoft_SDK_ROOT}/${extProjectName}-${CLFORTRAN_VERSION}-\${CMAKE_BUILD_TYPE}\" CACHE PATH \"\")\n")
  FILE(APPEND ${EMsoft_SDK_FILE} "set(CLFORTRAN_DIR \"\${EMsoft_SDK_ROOT}/${extProjectName}-${CLFORTRAN_VERSION}-\${CMAKE_BUILD_TYPE}/share/cmake\" CACHE PATH \"\")\n")
elseif(WIN32)
